...
def get_events(
    ...
    for _ in range(number_rows):
        yield {
            ...
            "event_date": fake.date_between(start_date="-1y", end_date="today").strftime("%Y-%m-%d"),  # noqa: E501
...
if __name__ == "__main__":
    ...
    for i in range(3):
        timestamp = fake.date_time_between(start_date="-3M", end_date="now").strftime("%Y%m%d_%H%M%S")  # noqa: E501
